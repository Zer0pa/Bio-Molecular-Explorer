...
from zer0pa_biomolecular_explorer.falsifiers.detectors import detect_clinical_overclaim
...
if TYPE_CHECKING:
    from zer0pa_biomolecular_explorer.reasoner.adapter import ReasonerAdapter
