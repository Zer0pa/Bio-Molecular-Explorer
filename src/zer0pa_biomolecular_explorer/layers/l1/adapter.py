...
from zer0pa_biomolecular_explorer.ids import audit_id, envelope_id, run_id as new_run_id
...
def _fill_stub_panel(
    ...
    from zer0pa_biomolecular_explorer.layers.l1.canned import _seed_float  # noqa: PLC0415
    for gene in _CANONICAL_PANEL_GENES:
        if gene not in panel:
