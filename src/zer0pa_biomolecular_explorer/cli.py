"""Zer0pa Bio-Molecular Explorer CLI.

Entry point: `zer0pa-biomolecular-explorer` (declared in pyproject.toml).
...
app = typer.Typer(
    ...
    help=(
        "Zer0pa Bio-Molecular Explorer CLI. Research use only. Not for diagnosis, "
...
def run_pathway1(
    ...
    """
    from zer0pa_biomolecular_explorer.runs import run_pathway1_cardiac_wedge, run_pathway1_compound
...
def graph_export(
    ...
    g = store.to_networkx()
    lines = ["digraph zer0pa_biomolecular_explorer_kg {", '  rankdir="LR";', '  node [shape=box, fontsize=10];']
...
def cutover_dryrun(
    ...
    from zer0pa_biomolecular_explorer.runpod_sim import (
        L1RunpodSimAdapter,
        L2RunpodSimAdapter,
        L5RunpodSimAdapter,
    )
