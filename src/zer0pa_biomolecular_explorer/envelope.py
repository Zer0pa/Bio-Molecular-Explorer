...
from zer0pa_biomolecular_explorer.boundary import RESEARCH_BOUNDARY, assert_boundary_string
...
class LayerEnvelope(BaseModel):
    ...
    in `zer0pa_biomolecular_explorer.contracts.*` constrain what goes inside via Pydantic
