...
from zer0pa_biomolecular_explorer.envelope import LayerEnvelope, FalsifierStatus
...
from zer0pa_biomolecular_explorer.ids import audit_id, claim_id, run_id as new_run_id
from zer0pa_biomolecular_explorer.kg import EdgeType, KGEdge, KGNode, KGStore, NodeType
from zer0pa_biomolecular_explorer.kg.validator import KGValidator
...
def run_cardiac_compound(
    ...
    *,
    ...
    # Per operator brief 2026-04-30 (historical command was `zer0pa-health run-cardiac`;
    # now `zer0pa-biomolecular-explorer run-cardiac`): "Make `zer0pa-biomolecular-explorer run-cardiac` use L6
